...
list_text_missing = ["illeg. word", "illeg. word/s", "illeg.word", "illeg.", "word illeg.", "blank", "words missing: MS torn",
                     ...
                     'word missing? MS torn', "word missing, MS torn", "one word deleted", "Greek word deleted",
                     "illeg.word, MS damaged", "overwritten in another hand: letters/numerals illeg.", "illeg.",
                      "3 words deleted", "2 words deleted", 'illeg. words deleted', "letters deleted",
                     "2 letters deleted", 'number? deleted', "letter deleted", "letter deleted?", "word deleted",
                     "above address, another hand: numerals? illeg.", "letters illeg.", "two words deleted", "deletion",
                     "word/s deleted"]
